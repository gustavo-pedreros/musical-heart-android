...
fun <T : Any> Observable<T>.runOnIo(scheduler: Scheduler): Observable<T> =
    subscribeOn(scheduler.io()).observeOn(scheduler.ui())

fun <T : Any> Single<T>.runOnIo(scheduler: Scheduler): Single<T> =
    subscribeOn(scheduler.io()).observeOn(scheduler.ui())

fun <T : Any> Flowable<T>.runOnIo(scheduler: Scheduler): Flowable<T> =
    subscribeOn(scheduler.io()).observeOn(scheduler.ui())
